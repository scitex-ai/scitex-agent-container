...
def test_restart_unrelated_caller_returns_403(client, isolated_env, pg_schema: str):
...
def test_restart_unrelated_caller_body_has_kind_acl_deny(client, isolated_env, pg_schema: str):
    # Arrange
    headers = _node_headers("alice")
    # Act
...
def test_restart_researcher_to_developer_not_403(client, isolated_env, pg_schema: str):
...
def test_node_caller_restarting_peer_does_not_self_schedule(client, isolated_env, pg_schema: str):

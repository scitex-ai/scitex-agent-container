...
def test_may_spawn_false_denies_root_spawn(db_path: Path, pg_schema: str) -> None:
...
def test_may_spawn_default_preserves_root_allow(db_path: Path, pg_schema: str) -> None:

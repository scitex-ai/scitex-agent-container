...
def test_delete_unrelated_caller_returns_403(client, isolated_env, pg_schema: str):
...
def test_delete_unrelated_caller_body_has_kind_acl_deny(client, isolated_env, pg_schema: str):
    # Arrange
    headers = _node_headers("alice")
    # Act
...
def test_delete_unrelated_caller_body_has_error_acl_deny(client, isolated_env, pg_schema: str):
    # Arrange
    headers = _node_headers("alice")
    # Act
...
def test_delete_unrelated_caller_body_has_reason_naming_target(client, isolated_env, pg_schema: str):
...
def test_delete_caller_can_target_direct_child(client, isolated_env, pg_schema: str):
...
def test_tail_unrelated_caller_returns_403(client, isolated_env, pg_schema: str):
    # Arrange
    headers = _node_headers("alice")
    # Act
...
def test_tail_unrelated_caller_body_has_kind_acl_deny(client, isolated_env, pg_schema: str):
    # Arrange
    headers = _node_headers("alice")
    # Act
...
def test_tail_caller_can_target_descendant(client, isolated_env, pg_schema: str):

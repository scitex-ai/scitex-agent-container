...
def test_developer_child_may_spawn(db_path: Path, pg_schema: str) -> None:
...
def test_non_developer_child_still_denied_spawn(db_path: Path, pg_schema: str) -> None:
...
def test_child_with_developer_late_in_its_groups_may_spawn(db_path: Path, pg_schema: str) -> None:
...
def test_child_with_researcher_late_in_its_groups_may_spawn(db_path: Path, pg_schema: str) -> None:
    # Arrange
...
def test_child_with_privileged_late_in_its_groups_may_spawn(db_path: Path, pg_schema: str) -> None:
    # Arrange
...
def test_labelled_researcher_child_may_spawn(db_path: Path, pg_schema: str) -> None:
...
def test_role_derived_researcher_child_may_spawn(db_path: Path, pg_schema: str) -> None:
...
def test_role_derived_researcher_child_may_manage_peer(db_path: Path, pg_schema: str) -> None:
...
def test_role_derived_developer_child_may_spawn(db_path: Path, pg_schema: str) -> None:
...
def test_worker_role_child_still_denied_spawn(db_path: Path, pg_schema: str) -> None:
...
def test_isolated_solver_child_still_denied_spawn(db_path: Path, pg_schema: str) -> None:
...
def test_researcher_child_with_may_spawn_false_is_denied(db_path: Path, pg_schema: str) -> None:
...
def test_developer_may_manage_unrelated_agent(db_path: Path, pg_schema: str) -> None:
...
def test_non_developer_cannot_manage_unrelated_agent(db_path: Path, pg_schema: str) -> None:
...
def test_researcher_may_manage_developer_target_via_mesh(db_path: Path, pg_schema: str) -> None:
...
def test_mesh_caller_cannot_manage_isolated_solver_target(db_path: Path, pg_schema: str) -> None:

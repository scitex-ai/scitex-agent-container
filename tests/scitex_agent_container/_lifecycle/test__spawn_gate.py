...
def test_gate_allows_root_caller_to_spawn(db_path, sac_name, pg_schema: str) -> None:
...
def test_gate_records_lineage_edge_for_root_caller(db_path, sac_name, pg_schema: str) -> None:
...
def test_gate_does_not_record_lineage_for_admin_caller(db_path, sac_name, pg_schema: str) -> None:
...
def test_gate_lineage_record_is_idempotent_on_same_parent(db_path, sac_name, pg_schema: str) -> None:
...
def test_gate_denies_child_caller_under_root_only_policy(db_path, sac_name, pg_schema: str) -> None:
...
def test_gate_allows_restart_keeps_existing_parent(db_path, sac_name, pg_schema: str) -> None:
...
def test_explicit_caller_arg_overrides_sac_name_env(db_path, sac_name, pg_schema: str) -> None:

...
def test_record_local_instance_persists_runtime_session_name(pg_schema: str, db_path, tmp_path) -> None:
...
def test_restart_and_record_refreshes_the_session_name(pg_schema: str, db_path, tmp_path) -> None:

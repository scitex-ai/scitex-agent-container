...
Mirrors ``src/scitex_agent_container/_state/state_store_incarnations.py``.
...
from scitex_agent_container._state.state_store_incarnations import (
    STORE_NAME,
    get_incarnation,
...
# the point: while ``incarnations`` stayed whitelisted, ``sac store query

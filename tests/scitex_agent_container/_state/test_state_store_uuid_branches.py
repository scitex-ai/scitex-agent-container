r"""Branch-coverage closure for ``state_store.new_uuid7``.
...
THIS FILE WAS ``test_state_store_connect_branches.py`` UNTIL THE ENGINE WENT.
The other half of it drove ``state_store._connect``: the WAL-mutation loop, its

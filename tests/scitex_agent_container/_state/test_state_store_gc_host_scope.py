...
Left unscoped, one host running ``sac store tick`` would tombstone LIVE agents
...
from scitex_agent_container._state.state_store_gc import (
...
def test_a_record_started_before_boot_is_reboot_swept(pg_schema: str) -> None:
    ...
    from scitex_agent_container._state.state_store_gc import _proc_btime

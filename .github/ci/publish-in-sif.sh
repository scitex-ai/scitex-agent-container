...
# (project=scitex-agent-container, owner=ywatanabe1989, repo=scitex-agent-container,
...
echo "PUBLISH-OK: scitex-agent-container dist/* uploaded to PyPI via manual OIDC trusted publishing"

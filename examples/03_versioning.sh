...
# multiple versioned images in dir-per-image layout:
#
#   ~/.scitex/agent-container/containers/
#     sac-scitex/
#       sac-scitex.sif          → currently active (symlink inside dir)
#       sac-scitex-2.28.14.sif
#       sac-scitex-2.28.15.sif
#     sac-scitex.sif            → top-level symlink to sac-scitex/sac-scitex.sif
#     ...
#

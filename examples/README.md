...
| File | What it shows |
|---|---|
| [`01_list_running_agents.py`](01_list_running_agents.py) | Programmatic version of `sac agents list --json` via the public Python API — useful when sac is embedded in a longer-running orchestrator. |

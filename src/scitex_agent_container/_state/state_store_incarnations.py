...
:mod:`.state_store_verdict_dedup` did before it. That primitive implements the
...
1. TIMESTAMPS STAY ISO-8601 TEXT, not the unix-seconds REAL that the dedup
   ...
   later as an unparseable timestamp. Same clock (:func:`state_store.now_iso`),
...
def _schema() -> Any:
    ...
    old module was equally lazy about ``state_store``, for the same reason
...
def record_incarnation_birth(
    ...
    *,
    ...
    from .state_store_hostname import resolve_host

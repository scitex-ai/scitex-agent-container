#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# File: src/scitex_agent_container/_state/state_store_instances_rename.py
"""The agent-rename step for ``instances`` records, and its inverse.

Split out of :mod:`.state_store_instances` under the per-file line cap, the same
way :mod:`.state_store_instances_store` is.
...
This is the same shape as :mod:`.state_store_incarnations`, which likewise
...
from .state_store_instances import scan_instances
from .state_store_instances_store import ACTOR, instance_key, run_with_reconnect

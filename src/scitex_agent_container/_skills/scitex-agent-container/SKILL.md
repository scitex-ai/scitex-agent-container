...
- [29_progress-reporting-to-lead.md](29_progress-reporting-to-lead.md) — sac agents push milestone updates to the lead's a2a inbox via `mcp__sac__a2a_send(target='lead', ...)` instead of letting the lead poll `agent_logs` + `gh`; KIND vocabulary, ACL grant, companion Stop-hook reminder

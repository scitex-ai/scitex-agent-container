...
Tree noun-group: every leaf is a real verb.
...
Old top-level forms (`send-accept`, `start-auto-accept`, `stop-auto-accept`)
still work but print a stderr deprecation warning.

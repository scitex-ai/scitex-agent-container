...
`sac agent status <name> --json` produces a single JSON blob by merging three
sources:

1. **Registry entry** — what was recorded at `sac agent start` time (name,
...
- [10_cli.md](10_cli.md) — `sac agent status` invocation and flags.

...
def agent_start(
    ...
    *,
    ...
    # Already running?
    forced_stop = False
    # Stale-lease cleanup (operator pain point — replaced the manual
    # ``sqlite3 … DELETE FROM instances …`` workaround, which stopped being
    # possible at all when the records left SQLite). When the runtime PID

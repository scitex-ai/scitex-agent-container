...
ALLOW = {
    ...
    # scitex-cards is the renamed scitex-todo (2026-07-16); BOTH console
    # scripts ship on PyPI, so both spellings stay whitelisted.
    "sac",
    "scitex-cards",
    "scitex-todo",
    "scitex-hpc",
...
def extend_allow_from_env() -> None:
    ...
    for extra in re.split(r"[,\s]+", os.environ.get("SAC_HPC_LOGIN_EXTRA_ALLOW", "")):
        if extra.strip():
